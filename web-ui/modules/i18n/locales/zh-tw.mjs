const zhTw = Object.freeze({
    ...
    'orchestration.quick.caption': '主按鈕負責開始執行；按 Enter 可先追加需求，輸入 /plan 可只探討方案。批次入列仍放在進階設定裡。',
    ...
    'orchestration.chat.input.workHint': '開始執行會先吸收目前輸入。',
    'orchestration.chat.input.workCaption': '主按鈕只保留開始執行：按 Enter 追加需求；輸入 /plan 只產生方案，不啟動任務。',
