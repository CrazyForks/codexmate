const zh = Object.freeze({
    ...
    'orchestration.hero.subtitle': '发一条任务消息，预览计划，再执行。',
    'orchestration.quick.kicker': '快速任务',
    'orchestration.quick.title': '你想让 Codexmate 完成什么？',
    'orchestration.quick.subtitle': '先写结果，编排器会预览计划、再执行；高级设置默认收起，不把发动机舱塞到用户脸上。',
    'orchestration.quick.caption': '主按钮会先生成计划再执行；批量或长任务再使用入队模式。',
    ...
    'orchestration.chat.input.placeholder': '直接告诉 Codexmate 要完成什么，例如：修复当前 PR review 评论，补回归测试，并给出验证截图',
    'orchestration.chat.input.hint': '像发消息一样写需求；当前 workspace、线程和运行方式默认自动带入，需要时再展开高级设置。',
    ...
    'orchestration.chat.assistant.singleReady': '已收到第一条需求。可以继续补需求 2，或直接预览并执行。',
