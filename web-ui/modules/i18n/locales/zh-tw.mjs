const zhTw = Object.freeze({
    ...
    'orchestration.hero.kicker': '任務執行緒',
    'orchestration.hero.title': '把任務聊到可執行',
    'orchestration.hero.subtitle': '送出任務訊息；需要起草執行方案時，在對話裡送出 /plan。',
    'orchestration.quick.kicker': '快速任務',
    'orchestration.quick.title': '你想讓 Codexmate 完成什麼？',
    'orchestration.quick.subtitle': '先寫清結果，保持對話式輸入；需要把草稿變成執行方案時送出 /plan。',
    'orchestration.quick.caption': '需要預覽方案時，在對話裡送出 /plan。批次或長任務的佇列模式仍放在進階設定裡。',
    ...
    'orchestration.chat.input.workHint': '直接開始執行會先吸收目前輸入。',
    'orchestration.chat.input.workCaption': '送出需求只會追加到對話；開始執行會先自動規劃，再讓 AI 真正跑任務。',
