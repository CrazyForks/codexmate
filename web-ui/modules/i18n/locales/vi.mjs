const vi = Object.freeze({
    ...
    'orchestration.readiness.empty.title': 'Viết tin nhắn tác vụ trước',
    'orchestration.readiness.empty.summary': 'Mô tả kết quả như một tin nhắn chat trước, rồi để bộ điều phối tách thành các node.',
    ...
    'orchestration.hero.subtitle': 'Gửi một tin nhắn tác vụ, xem trước kế hoạch, rồi chạy.',
    'orchestration.quick.kicker': 'Tác vụ nhanh',
    'orchestration.quick.title': 'Bạn muốn Codexmate hoàn thành việc gì?',
    'orchestration.quick.subtitle': 'Chỉ cần mô tả kết quả. Codexmate sẽ xem trước kế hoạch rồi chạy; thiết lập nâng cao được ẩn cho tới khi cần.',
    'orchestration.quick.caption': 'Nút chính ở giữa dùng để bắt đầu chạy. Nhấn Enter để thêm yêu cầu, hoặc gửi /plan nếu chỉ muốn xem kế hoạch. Chế độ hàng đợi vẫn nằm trong phần nâng cao cho tác vụ dài hoặc theo lô.',
    ...
    'orchestration.chat.input.placeholder': 'Nói thẳng Codexmate cần hoàn thành gì, vd: sửa comment review PR hiện tại, thêm test regression và đính kèm ảnh xác minh',
    'orchestration.chat.input.hint': 'Viết như một tin nhắn chat; workspace, thread và chế độ chạy được tự suy luận mặc định, khi cần mới mở Nâng cao.',
    ...
    'orchestration.chat.input.send': 'Gửi yêu cầu',
    'orchestration.chat.input.discuss': 'Thảo luận kế hoạch',
    ...
    'orchestration.chat.input.workHint': 'Bắt đầu chạy sẽ nhận nội dung hiện tại trước.',
    'orchestration.chat.input.workCaption': 'Chỉ còn một nút chính để bắt đầu chạy: nhấn Enter để thêm yêu cầu, hoặc gửi /plan để xem kế hoạch mà không chạy.',
    ...
    'orchestration.stage.subtitle': 'Gửi tin nhắn tác vụ trước, rồi xem trước kế hoạch.',
