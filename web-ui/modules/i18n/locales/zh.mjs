const zh = Object.freeze({
    ...
    'orchestration.hero.kicker': '任务线程',
    'orchestration.hero.title': '把任务聊到可执行',
    'orchestration.hero.subtitle': '发送任务消息；需要起草执行方案时，在对话里发送 /plan。',
    'orchestration.quick.kicker': '快速任务',
    'orchestration.quick.title': '你想让 Codexmate 完成什么？',
    'orchestration.quick.subtitle': '先写清结果，保持对话式输入；需要把草稿变成执行方案时发送 /plan。',
    'orchestration.quick.caption': '需要预览方案时，在对话里发送 /plan。批量或长任务的入队模式仍放在高级设置里。',
    ...
    'orchestration.chat.input.workHint': '直接开始执行会先吸收当前输入。',
    'orchestration.chat.input.workCaption': '发送需求只会追加到对话；开始执行会先自动规划，再让 AI 真正跑任务。',
