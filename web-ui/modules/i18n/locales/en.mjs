const en = Object.freeze({
    ...
    'orchestration.quick.caption': 'The centered primary button starts work. Press Enter to append a request first, or send /plan to discuss only. Batch queue mode stays in Advanced.',
    ...
    'orchestration.chat.input.workHint': 'Start work absorbs the current input first.',
    'orchestration.chat.input.workCaption': 'Only the primary Start work button remains: press Enter to append a request, or send /plan to preview without running.',
