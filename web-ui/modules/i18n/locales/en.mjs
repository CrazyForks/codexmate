const en = Object.freeze({
    ...
    'orchestration.chat.input.workHint': 'Start work will absorb the current input first.',
    'orchestration.chat.input.workCaption': 'Send request only appends to the conversation. Start work plans first, then makes the AI run the task.',
