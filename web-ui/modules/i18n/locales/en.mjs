const en = Object.freeze({
    ...
    'orchestration.hero.kicker': 'WEB AGENT',
    'orchestration.hero.title': 'Web Agent cockpit',
    'orchestration.hero.subtitle': 'Discuss the plan, start the agent, trace execution, and recover context inside one tab.',
    'orchestration.quick.kicker': 'AGENT CONSOLE',
    'orchestration.quick.title': 'Give Codexmate work like an agent: discuss, plan, execute',
    'orchestration.quick.subtitle': 'Discuss first, then start execution only after explicit intent. Workspace, thread, and records stay in the same cockpit.',
    'orchestration.quick.caption': 'Discuss plan only generates a plan. Start work absorbs the current input, plans, and starts the agent. Batch queue mode stays in Advanced.',
    ...
    'orchestration.chat.input.send': 'Send request',
    'orchestration.chat.input.discuss': 'Discuss plan',
    'orchestration.chat.input.work': 'Start work',
    'orchestration.chat.input.firstHint': 'This becomes request 1.',
    'orchestration.chat.input.workHint': 'Discuss plan or Start work will absorb the current input first.',
    'orchestration.chat.input.workCaption': 'Send request only appends to the conversation. Discuss plan only plans; Start work plans and makes the Web Agent run the task.',
    ...
    'orchestration.chat.assistant.empty': 'Send the first request. If there is a second one, send it next; Codexmate will keep context and process them in order.',
    ...
    'orchestration.agent.aria': 'Web Agent cockpit state',
    'orchestration.agent.kicker': 'WEB AGENT COCKPIT',
    'orchestration.agent.title': 'The agent owns the work chain inside this tab',
    'orchestration.agent.subtitle': 'Pick workspace/session on the left, discuss and execute in the center, keep live trace, run detail, and boundaries on the right.',
    ...
    'orchestration.agent.surface.session': 'Session',
    ...
    'orchestration.workspace.newSession': '+ New session',
    'orchestration.workspace.sessions.title': 'Session Inbox',
    'orchestration.workspace.sessions.empty.title': 'No records for this project yet',
    'orchestration.workspace.sessions.empty.subtitle': 'Start a new session, or refresh and choose existing runs.',
    ...
    'orchestration.readiness.empty.summary': 'Describe the outcome like a chat message first, then let the orchestrator split it into nodes.',
    ...
    'orchestration.actions.caption': '“Preview /plan and run” refreshes the plan when needed; use “Queue & start” for batch runs.',
    'orchestration.stage.title': 'Workspace opens when there is data',
    'orchestration.stage.subtitle': 'Send a task message first, then preview the plan.',
    ...
    'orchestration.result.title': 'Execution receipt',
    'orchestration.result.target': 'Target',
    'orchestration.result.receipt': 'Result',
    'orchestration.result.summary': 'Run summary',
    'orchestration.result.completed': 'Done: {target}',
