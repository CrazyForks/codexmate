const vi = Object.freeze({
    ...
    'orchestration.quick.caption': 'Muốn xem trước kế hoạch thì gửi /plan trong đoạn chat. Chế độ hàng đợi vẫn nằm trong phần nâng cao cho tác vụ dài hoặc theo lô.',
    ...
    'orchestration.result.title': 'Biên nhận thực thi',
    'orchestration.result.target': 'Mục tiêu',
    'orchestration.result.receipt': 'Kết quả',
    'orchestration.result.summary': 'Tóm tắt lần chạy',
    'orchestration.result.completed': 'Hoàn tất: {target}',
