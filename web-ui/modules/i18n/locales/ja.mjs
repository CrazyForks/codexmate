const ja = Object.freeze({
    ...
    'orchestration.quick.caption': '計画を確認したいときは、チャットで /plan を送信します。長い作業や一括処理は詳細設定のキューを使います。',
    ...
    'orchestration.result.title': '実行レシート',
    'orchestration.result.target': '実行対象',
    'orchestration.result.receipt': '結果',
    'orchestration.result.summary': '実行概要',
    'orchestration.result.completed': '完了: {target}',
