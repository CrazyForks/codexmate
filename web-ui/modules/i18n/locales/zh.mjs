const zh = Object.freeze({
    ...
    'orchestration.quick.caption': '主按钮负责开始执行；按 Enter 可先追加需求，输入 /plan 可只探讨方案。批量入队仍放在高级设置里。',
    ...
    'orchestration.chat.input.workHint': '开始执行会先吸收当前输入。',
    'orchestration.chat.input.workCaption': '主按钮只保留开始执行：按 Enter 追加需求；输入 /plan 只生成方案，不启动任务。',
