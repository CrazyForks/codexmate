const zhTw = Object.freeze({
    ...
    'orchestration.hero.subtitle': '發一條任務訊息，預覽計畫，再執行。',
    'orchestration.quick.kicker': '快速任務',
    'orchestration.quick.title': '你想讓 Codexmate 完成什麼？',
    'orchestration.quick.subtitle': '先寫結果，編排器會預覽計畫、再執行；進階設定預設收起，不把引擎艙塞到使用者面前。',
    'orchestration.quick.caption': '主按鈕會先生成計畫再執行；批次或長任務再使用佇列模式。',
    ...
    'orchestration.chat.input.placeholder': '直接告訴 Codexmate 要完成什麼，例如：修復目前 PR review 評論，補回歸測試，並提供驗證截圖',
    'orchestration.chat.input.hint': '像發訊息一樣寫需求；目前 workspace、執行緒和運行方式預設自動帶入，需要時再展開進階設定。',
    ...
    'orchestration.chat.assistant.singleReady': '已收到第一條需求。可以繼續補需求 2，或直接預覽並執行。',
    ...
    'orchestration.chat.meta.previewNext': '下一步：預覽計畫',
